...
dracula.setup({
  ...
  overrides = {
    ...
    CmpItemAbbrDeprecated = { fg = dracula.colors().nontext, bg = "NONE" },
    CmpItemAbbrMatch = { fg = dracula.colors().cyan, bg = "NONE" },
    CmpItemAbbrMatchFuzzy = { fg = dracula.colors().cyan, bg = "NONE" },
    CmpItemMenu = { fg = dracula.colors().purple, bg = "NONE" },
