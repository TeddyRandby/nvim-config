      ...
      spec = {
        {
          ...
          { "<leader>m", group = "[MOLTEN]", nowait = true, remap = false },
          {
            "<leader>me",
        ...
        },
        {
          ...
          { "<leader>m",  group = "[MOLTEN]",                                                                    nowait = true,                  remap = false },
          { "<leader>ml", "<cmd>MoltenEvaluateLine<cr>",                                                         desc = "[EVAL] Line",           remap = false },
          { "<leader>me", "<cmd>MoltenEvaluateOperator<cr>",                                                     desc = "[EVAL] Operator",       remap = false },
          ...
          { "<leader>fB", "<cmd>FzfLua buffers<cr>",                                                             desc = "[FIND] Buffers",        nowait = true, remap = false },
          ...
          { "<leader>lD", "<cmd>FzfLua lsp_definitions<cr>",                                                     desc = "[FIND] Definition",     nowait = true, remap = false },
          { "<leader>lE", "<cmd>FzfLua diagnostics_document<cr>",                                                desc = "[FIND] Diagnostics",    nowait = true, remap = false },
          { "<leader>lI", "<cmd>FzfLua lsp_implementations<cr>",                                                 desc = "[FIND] Implementation", nowait = true, remap = false },
          { "<leader>lR", "<cmd>FzfLua lsp_references<cr>",                                                      desc = "[FIND] Reference",      nowait = true, remap = false },
          { "<leader>lS", "<cmd>FzfLua lsp_document_symbols<cr>",                                                desc = "[FIND] Symbol",         nowait = true, remap = false },
